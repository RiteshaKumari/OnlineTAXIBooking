...
namespace taxi.Models
{
    public class Utility
    {
        ...
        {
            _connectionString = configuration.GetConnectionString("TaxiConn")
                ?? throw new ArgumentNullException("Connection string 'nagar_nigam' not found in appsettings.json.");
        }
        ...
        public DataSet Fn_DataSet(string procedure, params SqlParameter[] sqlParameters)
        {
            ...
            {
                using (SqlDataAdapter tda = new SqlDataAdapter("PRDA." + procedure, con))
                {
